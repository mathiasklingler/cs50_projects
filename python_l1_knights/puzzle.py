...
knowledge3 = And(
    knowledgeBase,
    # Sentence 1 already covered in knowledgebase
    Implication(Or(AKnight, AKnave), AKnight),
    Implication(Not(Or(AKnight, AKnave)), AKnave),
    # Sentence 2
    Or(Implication(And(BKnave,AKnave), BKnight),Implication(And(BKnave,Not(AKnave)), BKnight)),
    Or(Implication(Not(And(BKnave,AKnave)), BKnave), Implication(And(Not(BKnave),AKnave), BKnave)),
    # Sentence 3
